  ...
  return (
    <motion.div variants={item} style={{ perspective: "900px" }}>
      <motion.div
        ...
        className={`group relative bg-[#0F1A2E] border rounded-2xl p-7 flex flex-col gap-4 overflow-hidden cursor-pointer transition-[border-color,box-shadow] duration-300 ${
          hovered ? "border-[#3B82F6]/60 card-glow" : "border-[#1E3A8A]/30"
        }`}
      >
        {/* Holographic shine */}
        <div
          ...
          style={{
            background: `radial-gradient(circle at ${shine.x}% ${shine.y}%, rgba(249,115,22,0.07) 0%, transparent 52%)`,
        ...
        <div
          ...
          style={{
            background: `linear-gradient(105deg, transparent 20%, rgba(59,130,246,0.05) 40%, rgba(249,115,22,0.07) 50%, rgba(59,130,246,0.05) 60%, transparent 80%)`,
          }}
        />
        ...
        {/* Icon — orange */}
        <div className="w-12 h-12 rounded-xl flex items-center justify-center transition-transform duration-300 group-hover:scale-110 bg-orange-500/10 border border-orange-500/20 text-orange-400">
          {svc.icon}
        </div>
        ...
        <div className="mt-auto">
          <span className="inline-flex items-center gap-1 text-sm font-medium text-orange-400 group-hover:text-orange-300 transition-colors duration-200">
            Learn More
...
export default function ServicesGrid() {
  return (
    <section id="services" className="py-16 md:py-24 lg:py-32 bg-[#0A0F1E]">
