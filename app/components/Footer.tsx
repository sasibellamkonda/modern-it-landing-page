...
const footerLinks = {
  ...
  Company: ["About", "Careers", "Industries", "Contact"],
  Technology: ["Digital Transformation", "Cloud Transformation", "Managed Services"],
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10 mb-10 md:mb-12 text-center md:text-left">
          ...
          <div className="md:col-span-1 flex flex-col items-center md:items-start">
            <Link href="/" className="inline-flex mb-4">
              <Image src="/prak-logo.png" alt="PrakCorp" width={110} height={36} className="h-8 w-auto opacity-90" unoptimized />
            </Link>
